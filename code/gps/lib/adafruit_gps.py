...
class GPS:
    ...
    def __init__(self, uart, debug=False):
        ...
        self.latitude = None
        self.latitude_card = None
        self.longitude = None
        self.longitude_card = None
        self.fix_quality = 0
    ...
    def _parse_gll(self, data):
        ...
        self.latitude_card = data[1]

        # Longitude
        self.longitude = _read_degrees(data, 2, "w")
        self.longitude_card = data[3]
    ...
    def _parse_rmc(self, data):
        ...
        self.latitude_card = data[3]

        # Longitude
        self.longitude = _read_degrees(data, 4, "w")
        self.longitude_card = data[5]
    ...
    def _parse_gga(self, data):
        ...
        self.latitude_card = data[2]

        # Longitude
        self.longitude = _read_degrees(data, 3, "w")
        self.longitude_card = data[4]
    ...
    def _parse_gsv(self, talker, data):
        ...
        self.satellites_prev = self.satellites_in_view
